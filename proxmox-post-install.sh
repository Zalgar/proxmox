...
echo "Updating repo and upgrading, autoremoving and installing common packages"
apt update -y
apt dist-upgrade -y
apt autoremove -y
apt install sudo git curl python3 python3-pip
...
#remove nag prompt
echo "Removing No subscription nag prompt"
